...
class App extends Component {
  ...
  performFetch = () =>
    ...
    fetch('http://localhost:8000/pokemon?name=PsyDuCk&type=Water', {
    //fetch('http://localhost:8000/movie?genre=comedy&country=italy&avg_vote=5.4', {
      headers: {
        Authorization: 'Bearer 8a21de3e-d80e-11ea-87d0-0242ac130003',
      },
    });
